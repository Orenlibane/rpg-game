...
function updateFloorWarpOverlay() {
  ...
  for (const floor of warps) {
    ...
    btn.addEventListener('click', () => {
      import('./engine.js?v=43').then(({ warpToFloor }) => { warpToFloor(floor); });
      overlay.classList.add('hidden');
    });
