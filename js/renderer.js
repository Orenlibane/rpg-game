...
function updateFloorWarpOverlay() {
  ...
  for (const floor of warps) {
    ...
    btn.addEventListener('click', () => {
      import('./engine.js?v=45').then(({ warpToFloor }) => { warpToFloor(floor); });
      overlay.classList.add('hidden');
    });
